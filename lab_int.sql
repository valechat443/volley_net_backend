...
--
-- Host: 127.0.0.1
-- Creato il: Gen 08, 2024 alle 16:15
...
(157907, 95, '2023-10-28', '15:30:00', 'UTC', 'Finished', NULL, NULL, 'Final');
...
--
ALTER TABLE `game`
  MODIFY `id_game` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157908;
...
--
ALTER TABLE `period`
  MODIFY `id_period` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `score`
  MODIFY `id_score` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=621;
